...
export enum LanguageEN {
    ...
    PROJECT_DELETED_ERROR_DESCRIPTION='An error occurred while deleting your project.',
    PROJECT_DELETED_ERROR='Project could not be deleted',
    PROJECT_RESTORED='Project restored',
    PROJECT_RESTORED_DESCRIPTION='Your project has been successfully restored.',
    PROJECT_RESTORED_ERROR_DESCRIPTION='An error occurred while restoring your project.',
    ...
    RESTORE_PROJECT_DESCRIPTION='Are you sure you want to restore this project?',
    YES='Yes',
    NO='No',
    ...
    SIGN_UP='Sign up',
    PROJECT_SEARCH_INPUT_PLACEHOLDER='Search for a project name or description',
    PROJECT_SEARCH_BUTTON='Search',
}